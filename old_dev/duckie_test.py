...
def frame_processor(image):
	...
	cv2.imwrite("//home//userubuntu//gym-duckietown//rubbish//edges.png", edges)
	# since we are getting too many edges from our image, we apply 
	# a mask polygon to only focus on the road
	# Will explain Region selection in detail in further steps
	region = region_selection(edges)
	cv2.imwrite("//home//userubuntu//gym-duckietown//rubbish//region.png", region)
...
img = Image.open("//home//userubuntu//gym-duckietown//rubbish//clip2.jpg")
 
# asarray() class is used to convert
# PIL images into NumPy arrays
numpydata = np.asarray(img)
rus = frame_processor(numpydata)
cv2.imwrite("//home//userubuntu//gym-duckietown//rubbish//rus.png", rus)
